 ...
 */
public class ThreadSafeSchedule implements ISchedule {
  ...
  protected ThreadSafeScheduleGroup groupToExecute;
  protected ThreadSafeScheduleGroup endActions;
   ...
   */
  public ThreadSafeSchedule(ISchedulableActionFactory factory) {
    actionFactory = factory;
    actionQueue = new ActionQueue();
    groupToExecute = new ThreadSafeScheduleGroup();
    endActions = new ThreadSafeScheduleGroup();
  }
