...
medianTPI = function(df){
  return(median(df$TransmissionRate))}
 
q1TPI=function(df){
  return(quantile(df$TransmissionRate, 0.25))}

q3TPI=function(df){
  return(quantile(df$TransmissionRate, 0.75))}

processTPI = function(direc){
  
  
  files <- list.files(direc, pattern = "transmission", recursive = TRUE)
  files<- sapply(files, paste_file_name)
  
  files <- lapply(files, read.csv)
  
  files <- lapply(files, transRate)
  
  medians <- sapply(files, medianTPI)
  q1s <- sapply(files, q1TPI)
  q3s <- sapply(files, q3TPI)
  
  summaryTPI <- cbind(medians, q1s, q3s)
  summaryTPI <- as.data.frame(summaryTPI)
  
  
  multiplot(
    ggplot(summaryTPI) + geom_histogram(aes(x=q1s*52), binwidth = 1)
    +coord_cartesian(xlim = c(0, 30))
    +labs(title = "A.",
          x="25% Quantile, transmissions per infection year",
          y="Count simulations") ,
    
    ggplot(summaryTPI) + geom_histogram(aes(x=medians *52), binwidth = 1)+coord_cartesian(xlim = c(0, 100))
    +labs(title = "B.",
          x="Median, transmissions per infection year",
          y="Count simulations"),
    ggplot(summaryTPI) + geom_histogram(aes(x=q3s*52), binwidth = 1)
    +coord_cartesian(xlim = c(0, 40))
    +labs(title = "C.",
          x="75% Quantile, transmissions per infection year",
          y="Count simulations"),
    cols = 3)
  
}
transRate = function(df){
  df$TransmissionRate <- df$CountTransmissions / df$InfectionDuration
  return(df)
}
# 
...
# processTPI(dfcalibratedTPI)
# 
# dircal <- "/Users/me597/Documents/MSMoutput/JANUARY_27_2025_1_none_none/"
# 
# 
# 
# paste_file_name = function(filename){
#   return(paste("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_none_none/", filename, sep = ""))
# }
# processTPI("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_none_none/")
# 
# paste_file_name = function(filename){
#   return(paste("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_all_all/Batch_1_GISP_05_25/", filename, sep = ""))
# }
# processTPI("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_all_all/Batch_1_GISP_05_25/")
# 
# paste_file_name = function(filename){
#   return(paste("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_all_all/Batch_1_random_25/", filename, sep = ""))
# }
# processTPI("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_all_all/Batch_1_random_25/")
# 
# 
# paste_file_name = function(filename){
#   return(paste("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_all_all/Batch_1_test-of-cure_80_25/", filename, sep = ""))
# }
# processTPI("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_all_all/Batch_1_test-of-cure_80_25/")
# 
# 
# paste_file_name = function(filename){
#   return(paste("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_all_all/Batch_1_drug_sus_testing_80_25/", filename, sep = ""))
# }
# processTPI("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_all_all/Batch_1_drug_sus_testing_80_25/")
# 
# 
# paste_file_name = function(filename){
#   return(paste("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_all_all/Batch_1_realistic_combo_33_33_34_25/", filename, sep = ""))
# }
# processTPI("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_all_all/Batch_1_realistic_combo_33_33_34_25/")
# 
...
giant_e_box = function(df, title, counter_levels, counter_labels, xlim=100000){
...
############
cea = function(summaryGISP, summaryRT, summaryTOC, summaryDST, summaryRC){
...
viz_true_resist_A = function(df, title, yearX, linecolor="black"){
  df <- df %>% filter(tick >= 260)
  amrA <- ggplot(data = df, aes(x = (tick / 52) - 5, group = RunNumber)) + 
    geom_line( aes(y = ResistAIncidence/Incidence, alpha=resampled),size = 0.05, color=linecolor) +
    labs(x = "Year",
         y = "Prop. cases resistant\ndrug A",
         title = title) +
    coord_cartesian(ylim=c(0.0, 1.0)) +
...
viz_true_resist_B = function(df, title, yearX, linecolor="black"){
  df <- df %>% filter(tick >= 260)
  amrB <- ggplot(data = df, aes(x = (tick / 52) - 5, group = RunNumber)) + 
    geom_line( aes(y = ResistBIncidence/Incidence, alpha=resampled),size = 0.05, color=linecolor) +
    labs(x = "Year",
         y = "Prop. cases resistant\ndrug B", 
         title = title) +
    coord_cartesian(ylim=c(0.0, 1.0)) +
...
viz_true_resist_both = function(df, title, yearX, linecolor="black"){
  ...
  amrB <- ggplot(data = df, aes(x = (tick / 52) - 5, y = ResistBothIncidence/Incidence,  group = RunNumber)) + 
    geom_line( aes(alpha=resampled),size = 0.05, color=linecolor) +
    labs(x = "Year",
         y = "Prop. cases resistant\nboth drugs", 
         title = title) +
    coord_cartesian(ylim=c(0.0, 1.0)) +
...
viz_checkforsequelae = function(df, title, yearX){
  df <- df %>% filter(tick >= 260)
  
  plotX <- ggplot(data = df, aes(x = (tick / 52) - 5, y = CheckForSequelae, group = RunNumber)) +
    geom_line(aes(alpha=resampled), size = 0.05, color = "black") +
    labs(x = "Year",
         y = "Count checks for sequelae", 
         title = title) +
    geom_vline(xintercept=yearX-5, linetype="dashed")+
    coord_cartesian(ylim=c(0,20000))+
    my_theme +
...
viz_allsequelae = function(df, title, yearX){
  df <- df %>% filter(tick >= 260)
  
  plotX <- ggplot(data = df, aes(x = (tick / 52) - 5, y = CasesDGI + CasesEpidydimitis + CasesBothSequelae, group = RunNumber)) +
    geom_line(aes(alpha=resampled), size = 0.05, color = "black") +
    labs(x = "Year",
         y = "Count checks for sequelae", 
         title = title) +
...
viz_recovered_naturally = function(df, title, yearX){
  df <- df %>% filter(tick >= 260)
  
  plotX <- ggplot(data = df, aes(x = (tick / 52) - 5, y = RecoveredNaturally, group = RunNumber)) +
    geom_line(aes(alpha=resampled), size = 0.05, color = "black") +
    labs(x = "Year",
         y = "Recovered naturally", 
         title = title) +
    geom_vline(xintercept=yearX-5, linetype="dashed")+
    my_theme +
    theme(legend.position = "none")+
...
viz_failed_count = function(df, title, yearX){
  df <- df %>% filter(tick >= 260)
  
  df$Failures <- calc_failure(df)
  
  failed <- ggplot(data = df, aes(x=(tick / 52) - 5, group = RunNumber))+
    geom_line(aes(y=Failures, alpha=resampled), linewidth = 0.05, color = "black")+
    my_theme+
    labs(title=title, x= "Year", y = "Failure rate,\nall treatments")+
    geom_vline(xintercept=yearX-5, linetype="dashed")+
...
viz_checks_per_failed = function(df, title, yearX){
  df <- df %>% filter(tick >= 260)
  
  df$Failures <- calc_failure(df)
  
  failed <- ggplot(data = df, aes(x=(tick / 52) - 5, group = RunNumber))+
    geom_line(aes(y=CheckForSequelae/Failures, alpha=resampled), linewidth = 0.05, color = "black")+
    my_theme+
    labs(title=title, x= "Year", y = "Checks for Sequelae per Failure")+
    geom_vline(xintercept=yearX-5, linetype="dashed")+
...
visualize_parameters = function(df){
 ...
 g <- viz_delay_care(df,4, 0.02307692, 0.005479452)
  ...
  m<-ggplot(df) + 
    ...
    return(multiplot(a,b,c,d,e,f,g,h,i, j, k, cols = 3))
}
...
new_figure_four = function(df1, df2, df3, df4, df5, yearX){
  ...
  f<-viz_detected_resist_A(df1, "F.", yearX)+ theme(axis.title.x = element_blank()) 
  k<-viz_detected_resist_B(df1, "K.", yearX)+ theme(axis.title.x = element_blank())
  p<-viz_detected_resist_both(df1, "P.", yearX)+ theme(axis.title.x = element_blank())
  ...
  g<-viz_detected_resist_A(df2, "G.", yearX)+ theme(axis.title.y = element_blank(), axis.text.y = element_blank(),  axis.ticks.y = element_blank(),axis.title.x = element_blank())
  l<-viz_detected_resist_B(df2, "L.", yearX)+ theme(axis.title.y = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.title.x = element_blank())
  q<-viz_detected_resist_both(df2, "Q.", yearX)+ theme(axis.title.y = element_blank(), axis.text.y = element_blank(),  axis.ticks.y = element_blank(),axis.title.x = element_blank())
  ...
  h<-viz_detected_resist_A(df3, "H.", yearX)+ theme(axis.title.y = element_blank(), axis.ticks.y = element_blank(),axis.text.y = element_blank(), axis.title.x = element_blank())
  m<-viz_detected_resist_B(df3, "M.", yearX)+ theme(axis.title.y = element_blank(),  axis.ticks.y = element_blank(),axis.text.y = element_blank(), axis.title.x = element_blank())
  r<-viz_detected_resist_both(df3, "R.", yearX)+ theme(axis.title.y = element_blank(), axis.ticks.y = element_blank(), axis.text.y = element_blank(), axis.title.x = element_blank())
...
visualize_calibration_risk_groups = function(dfcalibrated){
  multiplot(
    viz_prev_highrisk(dfcalibrated, "A. High Risk"),
    viz_prev_lowrisk(dfcalibrated, "B. Low Risk"),
    cols = 2
  )
}
...
#decembaer 2024 process and visualize:
########
#load data
...
# december 2024
#####
dfsweep <- read.csv("/Users/me597/Documents/MSMoutput/output_DECEMBER_13_2024_overnight_sweep_none/sweepnone0supercombined.csv")
dfsweep$uniqueID <- as.integer(paste(as.character(dfsweep$RunNumber), as.character(dfsweep$seed), sep=''))
df_ends <- calc_weights(dfsweep)
df_best_ends <- resample(df_ends, 1000)

#save the resample including the replicates
write.csv(df_best_ends, file = "/Users/me597/Documents/MSM_calibrated_params/resample_w_replicates13dec24.csv")
...
df_best_ends <- read.csv("/Users/me597/Documents/MSM_calibrated_params/resample_w_replicates13dec24.csv")


#calibration runs
dfcalibrated  <-  read.csv("/Users/me597/Documents/MSMoutput/output_DECEMBER_23_2024_1_none_none/nonenone251combined.csv")
dfcalibrated <- identify(dfcalibrated, df_best_ends)
...
directory <- "/Users/me597/Documents/MSMoutput/output_DECEMBER_23_2024_1_all_all/"
...
dfsweep <- read.csv("/Users/me597/Documents/MSMoutput/MSMonly_output_JANUARY_7_2024_overnight_sweep_none/sweepnone0supercombined.csv")
dfsweep$uniqueID <- as.integer(paste(as.character(dfsweep$RunNumber), as.character(dfsweep$seed), sep=''))
df_ends <- calc_weights(dfsweep)
df_best_ends <- resample(df_ends, 1000)

#save the resample including the replicates
write.csv(df_best_ends, file = "/Users/me597/Documents/MSM_calibrated_params/resample_w_replicates7jan25.csv")
...
df_best_ends <- read.csv("/Users/me597/Documents/MSM_calibrated_params/resample_w_replicates7jan25.csv")


#calibration runs
dfcalibrated  <-  read.csv("/Users/me597/Documents/MSMoutput/JANUARY_8_2025_overnight_none_none/nonenone251combined.csv")
dfcalibrated <- identify(dfcalibrated, df_best_ends)
...
directory <- "/Users/me597/Documents/MSMoutput/JANUARY_8_2025_overnight_all_all/"
...
(dfGISP25$CasesEpidydimitis + dfGISP25$CasesDGI + dfGISP25$CasesBothSequelae) / dfGISP25$Incidence
...
directory <- "/Users/me597/Documents/MSMoutput/JANUARY_8_2025_overnight_all_all/"
directoryX <- "/Users/me597/Documents/MSMoutput/JANUARY_8_2025_overnight_all_combo/"
...
directory_switch<- "/Users/me597/Documents/MSMoutput/JANUARY_8_2025_overnight_switch_combo/"
...
directoryDST <- "/Users/me597/Documents/MSMoutput/JANUARY_8_2025_overnight_availrDST_combo/"
dfDST60 <-  read.csv(paste(directoryDST, "drug_sus_testing_60combo251combined.csv", sep=""))
dfDST60 <- identify(dfDST60, df_best_ends)
...
#adhereTOCsympt
directoryTOCsympt <- "/Users/me597/Documents/MSMoutput/JANUARY_8_2025_overnight_adhereTOCsympt_combo/"
...
#adhereTOCasympt
directoryTOCasympt <- "/Users/me597/Documents/MSMoutput/JANUARY_8_2025_overnight_adhereTOCasympt_combo/"
...
#RC distribution
directoryRC <- "/Users/me597/Documents/MSMoutput/JANUARY_8_2025_overnight_realistic_combo_combo/"
...
dfGISP25$Detected - dfGISP25$SuccessTreatmentsA - dfGISP25$SuccessTreatmentsB - dfGISP25$SuccessTreatmentsX - dfGISP25$UsageofErtapenem


dfcalibrated  <-  read.csv("/Users/me597/Documents/MSMoutput/JANUARY_13_2025_debug7_none_none/nonenone251combined.csv")
dfcalibrated <- identify(dfcalibrated, df_best_ends)
...
(dfTOCdebug$Detected - dfTOCdebug$SuccessTreatmentsA - dfTOCdebug$SuccessTreatmentsB - dfTOCdebug$SuccessTreatmentsX - dfTOCdebug$UsageofErtapenem - dfTOCdebug$UnknownFailedTreatments - dfTOCdebug$OngoingTreatments - dfTOCdebug$RecoveredNaturallyDuringTreatment)

dfTOCdebug$Detected - dfTOCdebug$AttemptTreatmentsA 

dfTOCdebug$unaccountedX <- (dfTOCdebug$AttemptTreatmentsX - dfTOCdebug$SuccessTreatmentsX)
dfTOCanomaly <- dfTOCdebug[dfTOCdebug$unaccountedX!=0,]
dfTOCanomaly[dfTOCanomaly$UsageofErtapenem!=0,]

dfTOCdebug$Detected - dfTOCdebug$DetectedAndSymptoms - dfTOCdebug$DetectedThruScreen

dfTOCdebug[dfTOCdebug$UsageofErtapenem!=0 & dfTOCdebug$AttemptTreatmentsX!=0,]

dfTOCdebug$Detected - dfTOCdebug$SuccessTreatmentsA - dfTOCdebug$SuccessTreatmentsB - dfTOCdebug$SuccessTreatmentsX - dfTOCdebug$UsageofErtapenem - dfTOCdebug$OngoingTreatments - dfTOCdebug$RecoveredNaturallyDuringTreatment - dfTOCdebug$DevelopedResistance  - dfTOCdebug$UnknownFailedTreatments
dfTOCdebug$Detected -  dfTOCdebug$SuccessTreatmentsB - dfTOCdebug$SuccessTreatmentsX - dfTOCdebug$UsageofErtapenem - dfTOCdebug$OngoingTreatments - dfTOCdebug$RecoveredNaturallyDuringTreatment - dfTOCdebug$DevelopedResistance  - dfTOCdebug$UnknownFailedTreatments
dfTOCdebug$Detected - dfTOCdebug$SuccessTreatmentsA  - dfTOCdebug$SuccessTreatmentsX - dfTOCdebug$UsageofErtapenem - dfTOCdebug$OngoingTreatments - dfTOCdebug$RecoveredNaturallyDuringTreatment - dfTOCdebug$DevelopedResistance  - dfTOCdebug$UnknownFailedTreatments
dfTOCdebug$Detected - dfTOCdebug$SuccessTreatmentsA - dfTOCdebug$SuccessTreatmentsB - dfTOCdebug$UsageofErtapenem - dfTOCdebug$OngoingTreatments - dfTOCdebug$RecoveredNaturallyDuringTreatment - dfTOCdebug$DevelopedResistance  - dfTOCdebug$UnknownFailedTreatments
dfTOCdebug$Detected - dfTOCdebug$SuccessTreatmentsA - dfTOCdebug$SuccessTreatmentsB - dfTOCdebug$SuccessTreatmentsX - dfTOCdebug$OngoingTreatments - dfTOCdebug$RecoveredNaturallyDuringTreatment - dfTOCdebug$DevelopedResistance  - dfTOCdebug$UnknownFailedTreatments
dfTOCdebug$Detected - dfTOCdebug$SuccessTreatmentsA - dfTOCdebug$SuccessTreatmentsB - dfTOCdebug$SuccessTreatmentsX - dfTOCdebug$UsageofErtapenem - dfTOCdebug$RecoveredNaturallyDuringTreatment - dfTOCdebug$DevelopedResistance  - dfTOCdebug$UnknownFailedTreatments
dfTOCdebug$Detected - dfTOCdebug$SuccessTreatmentsA - dfTOCdebug$SuccessTreatmentsB - dfTOCdebug$SuccessTreatmentsX - dfTOCdebug$UsageofErtapenem - dfTOCdebug$OngoingTreatments - dfTOCdebug$DevelopedResistance  - dfTOCdebug$UnknownFailedTreatments
...
dfTOCdebug$Detected - dfTOCdebug$SuccessTreatmentsA - dfTOCdebug$SuccessTreatmentsB - dfTOCdebug$SuccessTreatmentsX - dfTOCdebug$UsageofErtapenem - dfTOCdebug$OngoingTreatments - dfTOCdebug$RecoveredNaturallyDuringTreatment - dfTOCdebug$DevelopedResistance
dfTOCdebug$Detected - dfTOCdebug$SuccessTreatmentsA - dfTOCdebug$SuccessTreatmentsB - dfTOCdebug$SuccessTreatmentsX - dfTOCdebug$UsageofErtapenem - dfTOCdebug$OngoingTreatments - dfTOCdebug$RecoveredNaturallyDuringTreatment - dfTOCdebug$DevelopedResistance  - dfTOCdebug$UnknownFailedTreatments
...
dfGISPdebug<-  read.csv("/Users/me597/Documents/MSMoutput/JANUARY_13_2025_overnight_all_all/GISP_05combo251combined.csv")
dfGISPdebug <- identify(dfGISPdebug, df_best_ends)

dfGISPdebug$Detected - dfGISPdebug$DetectedAndSymptoms - dfGISPdebug$DetectedThruScreen

dfGISPdebug$Detected - dfGISPdebug$SuccessTreatmentsA - dfGISPdebug$SuccessTreatmentsB - dfGISPdebug$SuccessTreatmentsX - dfGISPdebug$UsageofErtapenem - dfGISPdebug$OngoingTreatments - dfGISPdebug$RecoveredNaturallyDuringTreatment - dfGISPdebug$DevelopedResistance  - dfGISPdebug$UnknownFailedTreatments

dfrandomdebug<-  read.csv("/Users/me597/Documents/MSMoutput/JANUARY_13_2025_overnight_all_all/randomcombo251combined.csv")
dfrandomdebug <- identify(dfrandomdebug, df_best_ends)

dfrandomdebug$Detected - dfrandomdebug$DetectedAndSymptoms - dfrandomdebug$DetectedThruScreen

dfrandomdebug$weird <- dfrandomdebug$Detected - dfrandomdebug$SuccessTreatmentsA - dfrandomdebug$SuccessTreatmentsB - dfrandomdebug$SuccessTreatmentsX - dfrandomdebug$UsageofErtapenem - dfrandomdebug$OngoingTreatments - dfrandomdebug$RecoveredNaturallyDuringTreatment - dfrandomdebug$DevelopedResistance  - dfrandomdebug$UnknownFailedTreatments
dfrandomanomaly <- dfrandomdebug[dfrandomdebug$weird!=0,]



dfDSTdebug<-  read.csv("/Users/me597/Documents/MSMoutput/JANUARY_13_2025_overnight_all_all/drug_sus_testing_80combo251combined.csv")
dfDSTdebug <- identify(dfDSTdebug, df_best_ends)

dfDSTdebug$Detected - dfDSTdebug$DetectedAndSymptoms - dfDSTdebug$DetectedThruScreen

dfDSTdebug$weird <- dfDSTdebug$Detected - dfDSTdebug$SuccessTreatmentsA - dfDSTdebug$SuccessTreatmentsB - dfDSTdebug$SuccessTreatmentsX - dfDSTdebug$UsageofErtapenem - dfDSTdebug$OngoingTreatments - dfDSTdebug$RecoveredNaturallyDuringTreatment - dfDSTdebug$DevelopedResistance  - dfDSTdebug$UnknownFailedTreatments
dfDSTanomaly<-dfDSTdebug[dfDSTdebug$weird!=0,]
...
dfsweep <- read.csv("/Users/me597/Documents/MSMoutput/JANUARY_24_2025_overnight_sweep_none/sweepnone0supercombined.csv")
dfsweep$uniqueID <- as.integer(paste(as.character(dfsweep$RunNumber), as.character(dfsweep$seed), sep=''))
df_ends <- calc_weights(dfsweep)
df_best_ends <- resample(df_ends, 1000)

#save the resample including the replicates
write.csv(df_best_ends, file = "/Users/me597/Documents/MSM_calibrated_params/resample_w_replicates24jan25.csv")
...
df_best_ends <- read.csv("/Users/me597/Documents/MSM_calibrated_params/resample_w_replicates24jan25.csv")



#calibration runs
dfcalibrated  <-  read.csv("/Users/me597/Documents/MSMoutput/JANUARY_26_2025_overnight_none_none/nonenone251combined.csv")
dfcalibrated <- identify(dfcalibrated, df_best_ends)
...
directory <- "/Users/me597/Documents/MSMoutput/JANUARY_26_2025_overnight_all_all/"
...
dfGISP25$Detected - dfGISP25$UnknownFailedTreatments - dfGISP25$SuccessTreatmentsA - dfGISP25$SuccessTreatmentsB - dfGISP25$SuccessTreatmentsX - dfGISP25$UsageofErtapenem - dfGISP25$RecoveredNaturallyDuringTreatment - dfGISP25$DevelopedResistance - dfGISP25$ReinfectedDuringTreatment

dfGISP25$Detected - dfGISP25$DetectedAndSymptoms - dfGISP25$DetectedThruScreen



#looking closer at the trajectories where multi-resistance gets very high
highmulti <- dfrandom25[(dfrandom25$ResistBothIncidence / dfrandom25$Incidence)>0.75,]
...
multiplot(
  viz_true_resist_both(highmultitraj, "A. Proportion of cases with multi-resistance", 25) + geom_line(size=2),
  viz_inc(highmultitraj, "B. Detected Cases", 25) + geom_line(size=2),
  viz_true_resist_both(highmultitraj, "C. Proportion of cases with multi-resistance", 25) + geom_line(size=2),
  viz_success_A(highmultitraj, "D. Successes with A")+ geom_line(size=2),
  viz_success_B(highmultitraj, "E. Successes with B")+ geom_line(size=2),
  viz_success_X(highmultitraj, "F. Successes with X")+ geom_line(size=2),
  viz_E(highmultitraj, "G. Uses of Ertapenem", 25, 10000) + geom_line(size=2),
  viz_unknown_failed(highmultitraj, "H. Unknown Treatment Failures", 25) + geom_line(size=2),
  viz_recovered_naturally_during_treatment(highmultitraj, "I. RecoveredNaturallyDuringTreatment", 25) + geom_line(size=2),
  viz_developed_resistance_during_treatment(highmultitraj, "J. DevelopedResistance", 25) + geom_line(size=2),
  viz_reinfected_during_treatment(highmultitraj, "K. Reinfected during treatment", 25) + geom_line(size=2),
  cols = 3)
...
highmultitraj$DetectedAndSymptoms / highmultitraj$Detected

highmultitraj$DetectedAndSymptoms - highmultitraj$SuccessTreatmentsA - highmultitraj$SuccessTreatmentsB - highmultitraj$SuccessTreatmentsX - highmultitraj$UsageofErtapenem 

onetraj <- dfrandom25[(dfrandom25$Detected>12000),]
...
#calibration runs
dfcalibrated  <-  read.csv("/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_none_none/nonenone251combined.csv")
dfcalibrated <- identify(dfcalibrated, df_best_ends)
...
directory <- "/Users/me597/Documents/MSMoutput/JANUARY_27_2025_2_all_all/"
...
directory <- "/Users/me597/Documents/MSMoutput/JANUARY_26_2025_overnight_all_all/"
directoryX <- "/Users/me597/Documents/MSMoutput/JANUARY_26_2025_overnight_all_combo/"
...
# transmission-per-infection data
...
#save the resample including the replicates
write.csv(df_best_ends, file = "/Users/me597/Documents/MSM_calibrated_params/resample_w_replicates31jan25.csv")
...
df_best_ends <- read.csv("/Users/me597/Documents/MSM_calibrated_params/resample_w_replicates31jan25.csv")



#calibration runs
dfcalibrated  <-  read.csv("/Users/me597/Documents/MSMoutput/JANUARY_31_2025_1_none_none/nonenone251combined.csv")
dfcalibrated <- identify(dfcalibrated, df_best_ends)
...
directory <- "/Users/me597/Documents/MSMoutput/FEBRUARY_5_2025_overnight_all_all/"
...
directory <- "/Users/me597/Documents/MSMoutput/JANUARY_31_2025_1_all_all/"
dfGISP25TPW <-   read.csv(paste(directory,"GISP_05combo251combinedTPW.csv", sep=""))
dfrandom25TPW <-  read.csv(paste(directory,"randomcombo251combinedTPW.csv", sep=""))
dfTOC25TPW <-  read.csv(paste(directory,"test-of-cure_80combo251combinedTPW.csv", sep=""))
dfDST25TPW <-  read.csv(paste(directory,"drug_sus_testing_80combo251combinedTPW.csv", sep=""))
dfreal25TPW <- read.csv(paste(directory,"realistic_combo_33_33_34combo251combinedTPW.csv", sep=""))

transmission_q1 = function(df, title){
  return(ggplot(data=df) +
           geom_histogram(aes(x=Q1*52), binwidth = 1) +
           my_theme +
           coord_cartesian(xlim=c(0, 30), ylim=c(0, 200))+
           labs(title = title, x = "Transmissions per infection year")) 
}
transmission_q2 = function(df, title){
  return(ggplot(data=df) +
           geom_histogram(aes(x=median*52), binwidth = 1) +
           my_theme +
           coord_cartesian(xlim=c(0, 30), ylim=c(0, 200))+
           labs(title = title, x = "Transmissions per infection year")) 
}
transmission_q3 = function(df, title){
  return(ggplot(data=df) +
           geom_histogram(aes(x=Q3*52)) +
           my_theme +
           coord_cartesian(xlim=c(0, 30), ylim=c(0, 200))+
           labs(title = title, x = "Transmissions per infection year")) 
}
...
directory <- "/Users/me597/Documents/MSMoutput/FEBRUARY_4_2025_overnight_all_all/"
directoryX <- "/Users/me597/Documents/MSMoutput/FEBRUARY_4_2025_overnight_all_combo/"
...
multiplot(
  ...
  nmb(cea_real_weighted(df_best_ends,dfreal15, dfGISP15, dfrandom15, dfTOC15, dfDST15), "B.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
  nmb(cea_real_weighted(df_best_ends,dfreal20, dfGISP20, dfrandom20, dfTOC20, dfDST20), "D.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
  nmb(cea_real_weighted(df_best_ends,dfreal25, dfGISP25, dfrandom25, dfTOC25, dfDST25), "F.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
  nmb(cea_real_weighted(df_best_ends,dfreal31, dfGISP31, dfrandom31, dfTOC31, dfDST31), "H.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
...
directory_switch<- "/Users/me597/Documents/MSMoutput/FEBRUARY_4_2025_overnight_switch_combo/"
...
multiplot(
  ...
  visualize_cea_weighted_real("A. GISP 3%", df_best_ends,dfreal25,dfGISP3, dfrandom25, dfTOC25, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-10, 20), xlim = c(-200, 50)),
  visualize_cea_weighted_real("C. GISP 4%", df_best_ends,dfreal25,dfGISP4, dfrandom25, dfTOC25, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-10, 20), xlim = c(-200, 50)),
  visualize_cea_weighted_real("E. GISP 5% (default)", df_best_ends,dfreal25,dfGISP5, dfrandom25, dfTOC25, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-10, 20), xlim = c(-200, 50)),  
  visualize_cea_weighted_real("G. GISP 6%",df_best_ends, dfreal25,dfGISP6, dfrandom25, dfTOC25, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-10, 20), xlim = c(-200, 50)),
  visualize_cea_weighted_real("I. GISP 7%",df_best_ends, dfreal25,dfGISP7, dfrandom25, dfTOC25, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-10, 20), xlim = c(-200, 50)),
  
  nmb(cea_real_weighted(df_best_ends,dfreal25,dfGISP3, dfrandom25, dfTOC25, dfDST25), "B.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
  nmb(cea_real_weighted(df_best_ends,dfreal25,dfGISP4, dfrandom25, dfTOC25, dfDST25), "D.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
  nmb(cea_real_weighted(df_best_ends,dfreal25,dfGISP5, dfrandom25, dfTOC25, dfDST25), "F.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
  nmb(cea_real_weighted(df_best_ends,dfreal25,dfGISP6, dfrandom25, dfTOC25, dfDST25), "H.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
  nmb(cea_real_weighted(df_best_ends,dfreal25,dfGISP7, dfrandom25, dfTOC25, dfDST25), "J.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
...
directoryDST <- "/Users/me597/Documents/MSMoutput/FEBRUARY_4_2025_overnight_availrDST_combo/"
dfDST60 <-  read.csv(paste(directoryDST, "drug_sus_testing_60combo251combined.csv", sep=""))
dfDST60 <- identify(dfDST60, df_best_ends)
...
multiplot(
  ...
  nmb(cea_real_weighted(df_best_ends,dfreal25, dfGISP25, dfrandom25, dfTOC25, dfDST60), "B.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
  nmb(cea_real_weighted(df_best_ends,dfreal25, dfGISP25, dfrandom25, dfTOC25, dfDST70), "D.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
  nmb(cea_real_weighted(df_best_ends,dfreal25, dfGISP25, dfrandom25, dfTOC25, dfDST80), "F.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
  nmb(cea_real_weighted(df_best_ends,dfreal25, dfGISP25, dfrandom25, dfTOC25, dfDST90), "H.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
  nmb(cea_real_weighted(df_best_ends,dfreal25, dfGISP25, dfrandom25, dfTOC25, dfDST100), "J.")+ coord_cartesian(ylim = c(-5000000, 10000000)),
...
#adhereTOCsympt
directoryTOCsympt <- "/Users/me597/Documents/MSMoutput/FEBRUARY_4_2025_overnight_adhereTOCsympt_combo/"
...
#adhereTOCasympt
directoryTOCasympt <- "/Users/me597/Documents/MSMoutput/FEBRUARY_4_2025_overnight_adhereTOCasympt_combo/"
...
#RC distribution
directoryRC <- "/Users/me597/Documents/MSMoutput/FEBRUARY_5_2025_debug1_realistic_combo_combo/"
...
#save the resample including the replicates
write.csv(df_best_ends, file = "/Users/me597/Documents/MSM_calibrated_params/resample_w_replicates14feb25.csv")
...
visualize_calibration_MSM(df_best_traj)
df_best_ends <- read.csv("/Users/me597/Documents/MSM_calibrated_params/resample_w_replicates14feb25.csv")
visualize_parameters(df_best_ends)
...
#calibration runs
dfcalibrated  <-  read.csv("/Users/me597/Documents/MSMoutput/FEBRUARY_14_2025_overnight_none_none/nonenone251combined.csv")
dfcalibrated <- identify(dfcalibrated, df_best_ends)
...
directory <- "/Users/me597/Documents/MSMoutput/FEBRUARY_14_2025_overnight_all_all/"
...
cost_accounting = function(df){
  cost <- 0
   cost <- cost + (df$AttemptTreatmentsA* df$DrugATreatmentCost)
   cost <- cost + (df$AttemptTreatmentsB* df$DrugBTreatmentCost)
   cost <- cost + (df$AttemptTreatmentsX* df$DrugXTreatmentCost)
   cost <- cost + (df$UsageofErtapenem* df$DrugETreatmentCost) 
   cost <- cost + (df$VisitsToClinic*df$CareCost)
   cost <- cost + (df$DiagnosticTests * df$TestCost)
   cost <- cost + (df$StrainTests * df$StrainTestCost)
   cost <- cost + (df$CasesDGI * 2916)
   cost <- cost + (df$CasesEpidydimitis * 522)
   cost <- cost + (df$CasesBothSequelae * 3438)
   return(cost)
}

multiplot(
  viz_checkforsequelae(dfGISP25, "A. GISP", 25),
  viz_allsequelae(dfGISP25, "A. GISP", 25),
  
  viz_recovered_naturally(dfGISP25, "A. GISP", 25),
  viz_failed_count(dfGISP25, "A. GISP", 25),

  viz_checkforsequelae(dfrandom25, "B. RT", 25),
  viz_allsequelae(dfrandom25, "B. RT", 25),
  
  viz_recovered_naturally(dfrandom25, "B. RT", 25),
  viz_failed_count(dfrandom25, "B. RT", 25),
...
dfGISP25$costRecalc <- cost_accounting(dfGISP25)
dfrandom25$costRecalc <- cost_accounting(dfrandom25)
dfreal25$costRecalc <- cost_accounting(dfreal25)
dfTOC25$costRecalc <- cost_accounting(dfTOC25)
dfDST25$costRecalc <- cost_accounting(dfDST25)


dfGISP25cost <- cost_df(dfGISP25)
dfrandom25cost <- cost_df(dfrandom25)

dfTOC25cost <- cost_df(dfTOC25)

dfDST25cost <- cost_df(dfDST25)
...
directory <- "/Users/me597/Documents/MSMoutput/FEBRUARY_11_2025_debug1_all_all/"
directoryX <- "/Users/me597/Documents/MSMoutput/FEBRUARY_11_2025_debug1_all_combo/"
...
multiplot(
  ...
  visualize_cea_weighted_real("A. Drug X available year 10", df_best_ends,dfreal15, dfGISP15, dfrandom15, dfTOC15, dfDST15)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-300, 200)),
  visualize_cea_weighted_real("C. Drug X available year 15", df_best_ends,dfreal20, dfGISP20, dfrandom20, dfTOC20, dfDST20)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-300, 200)),
...
directory <- "/Users/me597/Documents/MSMoutput/FEBRUARY_26_2025_overnight_all_all/"
...
# feb 27 25
#######
dfsweep <- read.csv("/Users/me597/Documents/MSMoutput/february_26_2025_overnight_sweep_none/sweepnone0supercombined.csv")
dfsweep$uniqueID <- as.integer(paste(as.character(dfsweep$RunNumber), as.character(dfsweep$seed), sep=''))
df_ends <- calc_weights(dfsweep)
df_best_ends <- resample(df_ends, 1000)

#save the resample including the replicates
write.csv(df_best_ends, file = "/Users/me597/Documents/MSM_calibrated_params/resample_w_replicates26feb25.csv")
...
directory <- "/Users/me597/Documents/MSMoutput/FEBRUARY_28_2025_overnight_all_all/"
directoryX <- "/Users/me597/Documents/MSMoutput/FEBRUARY_28_2025_overnight_all_combo/"
...
directory_switch<- "/Users/me597/Documents/MSMoutput/FEBRUARY_28_2025_overnight_switch_combo/"
...
directoryDST <- "/Users/me597/Documents/MSMoutput/FEBRUARY_28_2025_overnight_availrDST_combo/"
dfDST60 <-  read.csv(paste(directoryDST, "drug_sus_testing_60combo251combined.csv", sep=""))
dfDST60 <- identify(dfDST60, df_best_ends)
...
#adhereTOCsympt
directoryTOCsympt <- "/Users/me597/Documents/MSMoutput/FEBRUARY_28_2025_overnight_adhereTOCsympt_combo/"
...
multiplot(
  ...
  visualize_cea_weighted_real("C. TOC symptomatic 70%", df_best_ends,dfreal25,dfGISP25, dfrandom25, dfTOCadsympt70, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-200, 50)),
  visualize_cea_weighted_real("E. TOC symptomatic 80% (default)", df_best_ends,dfreal25,dfGISP25, dfrandom25, dfTOCadsympt80, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-200, 50)),  
  visualize_cea_weighted_real("G. TOC symptomatic 90%",df_best_ends, dfreal25,dfGISP25, dfrandom25, dfTOCadsympt90, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-200, 50)),
  visualize_cea_weighted_real("I. TOC symptomatic 100%",df_best_ends, dfreal25,dfGISP25, dfrandom25, dfTOCadsympt100, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-200, 50)),
...
#adhereTOCasympt
directoryTOCasympt <- "/Users/me597/Documents/MSMoutput/FEBRUARY_28_2025_overnight_adhereTOCasympt_combo/"
...
multiplot(
  ...
  visualize_cea_weighted_real("C. TOC asymptomatic 70%", df_best_ends,dfreal25,dfGISP25, dfrandom25, dfTOCadasympt70, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-200, 50)),
  visualize_cea_weighted_real("E. TOC asymptomatic 80% (default)", df_best_ends,dfreal25,dfGISP25, dfrandom25, dfTOCadasympt80, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-200, 50)),  
  visualize_cea_weighted_real("G. TOC asymptomatic 90%",df_best_ends, dfreal25,dfGISP25, dfrandom25, dfTOCadasympt90, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-200, 50)),
  visualize_cea_weighted_real("I. TOC asymptomatic 100%",df_best_ends, dfreal25,dfGISP25, dfrandom25, dfTOCadasympt100, dfDST25)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-200, 50)),
...
# march 3 test
########
directory <- "/Users/me597/Documents/MSMoutput/MARCH_3_2025_debug1_all_all/"
...
mean(na.omit(dfGISP25$CasesDGI / dfGISP25$Detected))
quantile(na.omit(dfGISP25$CasesDGI / dfGISP25$Detected), probs = c(0.025, 0.975))
...
# august 2025 revisions for clearance
###############
...
#calibrated "dry" runs
dfcalibrated  <-  read.csv("/Users/me597/Documents/MSMoutput/AUG_12_2025_overnight_none_none/nonenone251combined.csv")
dfcalibrated <- identify(dfcalibrated, df_best_ends)
...
#main text experiment/base analysis
directory <- "/Users/me597/Documents/MSMoutput/AUG_12_2025_overnight_all_all/"
...
#table 1 row 1 - gonorrhea incidence
mean(summary_GISP$cumulativeInc)
quantile(summary_GISP$cumulativeInc, probs = c(0.025, 0.975))
...
#### if drugs were more expensive, who would fare worse?
mean(summary_GISP$AttemptTreatmentsB)
quantile(summary_GISP$AttemptTreatmentsB, probs = c(0.025, 0.975))

mean(summary_random$AttemptTreatmentsB)
quantile(summary_random$AttemptTreatmentsB, probs = c(0.025, 0.975))

mean(summary_TOC$AttemptTreatmentsB)
quantile(summary_TOC$AttemptTreatmentsB, probs = c(0.025, 0.975))

mean(summary_real$AttemptTreatmentsB)
quantile(summary_real$AttemptTreatmentsB, probs = c(0.025, 0.975))

mean(summary_GISP$AttemptTreatmentsX)
quantile(summary_GISP$AttemptTreatmentsX, probs = c(0.025, 0.975))

mean(summary_random$AttemptTreatmentsX)
quantile(summary_random$AttemptTreatmentsX, probs = c(0.025, 0.975))

mean(summary_TOC$AttemptTreatmentsX)
quantile(summary_TOC$AttemptTreatmentsX, probs = c(0.025, 0.975))

mean(summary_real$AttemptTreatmentsX)
...
ceatable_noDST <- cea_real_weighted_noDST(df_best_ends, dfreal25, dfGISP25, dfrandom25, dfTOC25)

ceatable_noDST$trajMinCost <- pmin(ceatable_noDST$GISPcumulativeCosts, ceatable_noDST$RandomcumulativeCosts, ceatable_noDST$TOCcumulativeCosts, ceatable_noDST$RCcumulativeCosts)
ceatable_noDST$trajMinQALYsLost <- pmin(ceatable_noDST$GISPcumulativeQALYs, ceatable_noDST$RandomcumulativeQALYs, ceatable_noDST$TOCcumulativeQALYs, ceatable_noDST$RCcumulativeQALYs)
  
nrow(ceatable_noDST[ceatable_noDST$GISPcumulativeCosts == ceatable_noDST$trajMinCost, ])
nrow(ceatable_noDST[ceatable_noDST$RandomcumulativeCosts == ceatable_noDST$trajMinCost, ])
nrow(ceatable_noDST[ceatable_noDST$TOCcumulativeCosts == ceatable_noDST$trajMinCost, ])
nrow(ceatable_noDST[ceatable_noDST$RCcumulativeCosts == ceatable_noDST$trajMinCost, ])


plot(ceatable_noDST$CareCost, ceatable_noDST$GISPcumulativeCostsAdj)
plot(ceatable_noDST$TestCost, ceatable_noDST$GISPcumulativeCostsAdj)
plot(ceatable_noDST$StrainTestCost, ceatable_noDST$GISPcumulativeCostsAdj)
plot(ceatable_noDST$DrugETreatmentCost, ceatable_noDST$GISPcumulativeCostsAdj)
plot(ceatable_noDST$DrugATreatmentCost, ceatable_noDST$GISPcumulativeCostsAdj)
plot(ceatable_noDST$DrugBTreatmentCost, ceatable_noDST$GISPcumulativeCostsAdj)
plot(ceatable_noDST$TransmissionMSM, ceatable_noDST$GISPcumulativeCostsAdj)
plot(ceatable_noDST$ProbSymptomaticMSM, ceatable_noDST$GISPcumulativeCostsAdj)
plot(ceatable_noDST$DelayToSeekCareMSM, ceatable_noDST$GISPcumulativeCostsAdj)
plot(ceatable_noDST$DelayToRetreatmentMSM, ceatable_noDST$GISPcumulativeCostsAdj)
plot(ceatable_noDST$PercentResistantA, ceatable_noDST$GISPcumulativeCostsAdj)
plot(ceatable_noDST$PropHighActivity, ceatable_noDST$GISPcumulativeCostsAdj)
plot(ceatable_noDST$activityGroupTransmissionRatio, ceatable_noDST$GISPcumulativeCostsAdj)


plot(ceatable_noDST$TransmissionMSM, ceatable_noDST$GISPcumulativeQALYsAdj)
plot(ceatable_noDST$ProbSymptomaticMSM, ceatable_noDST$GISPcumulativeQALYsAdj)
plot(ceatable_noDST$DelayToSeekCareMSM, ceatable_noDST$GISPcumulativeQALYsAdj)
plot(ceatable_noDST$DelayToRetreatmentMSM, ceatable_noDST$GISPcumulativeQALYsAdj)
plot(ceatable_noDST$PercentResistantA, ceatable_noDST$GISPcumulativeQALYsAdj)


plot(ceatable_noDST$TransmissionMSM, ceatable_noDST$RandomcumulativeQALYsAdj)
plot(ceatable_noDST$ProbSymptomaticMSM, ceatable_noDST$RandomcumulativeQALYsAdj)
plot(ceatable_noDST$DelayToSeekCareMSM, ceatable_noDST$RandomcumulativeQALYsAdj)
plot(ceatable_noDST$DelayToRetreatmentMSM, ceatable_noDST$RandomcumulativeQALYsAdj)
plot(ceatable_noDST$PercentResistantA, ceatable_noDST$RandomcumulativeQALYsAdj)

ceatable_noDST[ceatable_noDST$RandomcumulativeQALYsAdj >300, ]

new_figure_four_noDST(dfGISP25[dfGISP25$seed==79597,], dfrandom25[dfrandom25$seed==79597,], dfTOC25[dfTOC25$seed==79597,], dfreal25[dfreal25$seed==79597,], 25)



ceatable_noDST[ceatable_noDST$RandomcumulativeQALYsAdj <-200, ]
new_figure_four_noDST(dfGISP25[dfGISP25$seed==97541,], dfrandom25[dfrandom25$seed==97541,], dfTOC25[dfTOC25$seed==97541,], dfreal25[dfreal25$seed==97541,], 25)



nrow(ceatable_noDST[ceatable_noDST$GISPcumulativeCosts < ceatable_noDST$RandomcumulativeCosts, ])
nrow(ceatable_noDST[ceatable_noDST$GISPcumulativeQALYs < ceatable_noDST$RandomcumulativeQALYs, ])


nrow(ceatable_noDST[ceatable_noDST$GISPcumulativeQALYs == ceatable_noDST$trajMinQALYsLost, ])
nrow(ceatable_noDST[ceatable_noDST$RandomcumulativeQALYs == ceatable_noDST$trajMinQALYsLost, ])
nrow(ceatable_noDST[ceatable_noDST$TOCcumulativeQALYs == ceatable_noDST$trajMinQALYsLost, ])
nrow(ceatable_noDST[ceatable_noDST$RCcumulativeQALYs == ceatable_noDST$trajMinQALYsLost, ])
...
#figure S3 - parameter estimates
visualize_parameters(df_best_ends)

#availability of X

directory <- "/Users/me597/Documents/MSMoutput/AUG_12_2025_overnight_all_all/"
directoryX <- "/Users/me597/Documents/MSMoutput/AUG_12_2025_overnight_all_combo/"
directorycombo  <- "/Users/me597/Documents/MSMoutput/AUG_12_2025_overnight_all_combo/"
...
directory_switch<- "/Users/me597/Documents/MSMoutput/AUG_12_2025_overnight_switch_combo/"
...
#adhereTOCsympt
directoryTOCsympt <- "/Users/me597/Documents/MSMoutput/AUG_12_2025_overnight_adhereTOCsympt_combo/"
...
#adhereTOCasympt
directoryTOCasympt <- "/Users/me597/Documents/MSMoutput/AUG_12_2025_overnight_adhereTOCasympt_combo/"
...
#combo (no DST)
directoryRC <- "/Users/me597/Documents/MSMoutput/AUG_12_2025_overnight_realistic_combo_combo/"
...
directoryDST <- "/Users/me597/Documents/MSMoutput/AUG_12_2025_overnight_availrDST_combo/"
dfDST60 <-  read.csv(paste(directoryDST, "drug_sus_testing_60combo251combined.csv", sep=""))
dfDST60 <- identify(dfDST60, df_best_ends)
...
multiplot(
  visualize_cea_weighted_real("A. MT 45-45-10",df_best_ends, dfRC45_45_10,dfGISP25, dfrandom25, dfTOC25, dfDST80)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-200, 50)),
  visualize_cea_weighted_real("C. MT 40-40-20", df_best_ends,dfRC40_40_20,dfGISP25, dfrandom25, dfTOC25, dfDST80)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-200, 50)),
  visualize_cea_weighted_real("E. MT 35-35-30",df_best_ends, dfRC35_35_30,dfGISP25, dfrandom25, dfTOC25, dfDST80)+theme(legend.position = "none")+coord_cartesian(ylim=c(-20, 20), xlim = c(-200, 50)),
  
  nmb(cea_real_weighted(df_best_ends,dfRC45_45_10,dfGISP25, dfrandom25, dfTOC25, dfDST80), "B.")+ coord_cartesian(ylim = c(-20000000, 10000000)),
  nmb(cea_real_weighted(df_best_ends,dfRC40_40_20,dfGISP25, dfrandom25, dfTOC25, dfDST80), "D.") + coord_cartesian(ylim = c(-15000000, 15000000)),
  nmb(cea_real_weighted(df_best_ends,dfRC35_35_30,dfGISP25, dfrandom25, dfTOC25, dfDST80), "F.")+ coord_cartesian(ylim = c(-15000000, 15000000)),
