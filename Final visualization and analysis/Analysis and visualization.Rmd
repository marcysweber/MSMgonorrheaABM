...
sweepdir <- "/Users/me597/Documents/MSMoutput/output_MAY_01_2026_overnight_3_sweep_none_0.0_0.0/" # e.g. "/Users/me597/Documents/MSMoutput/output_MARCH_31_2026_debug_1_sweep_none_0.0_0.0/"
...
dfsweep <- read.csv(paste(sweepdir, "sweepnone0.00.0supercombined.csv", sep=''))
dfsweep$uniqueID <- as.numeric(paste(as.character(dfsweep$RunNumber), as.character(dfsweep$seed), sep=''))

#dfsweep2 <- read.csv(paste(sweepdir2, "sweepnone0.00.0_2combined.csv", sep=''))
#dfsweep2$uniqueID <- as.integer(paste(as.character(dfsweep2$RunNumber), as.character(dfsweep2$seed), sep=''))
...
#dfsweep<- rbind(dfsweep1, dfsweep2, dfsweep3)
...
df_best_ends <- df_ends_sorted[1:150,]
...
dfGISPparcal <- read.csv("/Users/me597/Documents/MSMoutput/output_MAY_03_2026_overnight_3_GISPparcal_combo_0.0_0.0/GISPrand_05combo0.0_0.0_1combined.csv")
...
df_best_ends <- read.csv("/usr/local/MSM_final_calibrated_params/resample_w_replicates_2026-04-10.csv") #/Users/me597/Documents/MSM_final_calibrated_params/resample_w_replicates7mar25.csv")
visualize_parameters(df_best_ends)

df_parcal <- read.csv("/usr/local/MSM_parcalibrated_params/resample_w_replicates_2026-04-08.csv") #/Users/me597/Documents/MSM_final_calibrated_params/resample_w_replicates7mar25.csv")
...
directory <- "/Users/me597/Documents/MSMoutput/output_MAY_03_2026_overnight_5_all_all_0.0_0.0/"
