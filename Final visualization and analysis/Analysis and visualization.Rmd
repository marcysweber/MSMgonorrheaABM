...
# Figure 2
```{r calibrationProcedureStep1, include = false}
...
```{r examiningPriorsAndPosteriors}
...
```{r loadParCalibration, include=FALSE}
...
```{r calibrationProcedureStep2, include=FALSE}
...
```{r loadExperimentData, echo=FALSE}
...
```{r fitnessCostsSummary1, echo = FALSE, warnings=FALSE, message=FALSE, fig.width=8, fig.height=3}
